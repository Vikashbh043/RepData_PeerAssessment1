...
```{r loading data}
getwd()
sewd("C:/Users/Vikash/Desktop/Assignments/RProgramming")
unzip(zipfile = "Activity.zip", overwrite = TRUE, exdir = "C:/Users/Vikash/Desktop/Assignments/RProgramming", unzip = "internal")
...
steps_datedate <- aggregate(steps ~ date, file1_valid, sum)
head(steps_date)
